...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [10] = {
    ...
    {_______, _______, _______, _______, _______, _______, _______, M(OPEN_LAYER13), M(_QUOT), M(_MINS), M(_EQL), MO(12)},
    {_______, _______, _______, _______, _______, _______, _______, OSL(13), _______, _______, _______, MO(11)},
  ...
  [13] = {
    ...
    {_______, _______, _______, _______, _______, _______, _______, M(CLOSE_LAYER13), M(4), M(5), M(6), _______},
