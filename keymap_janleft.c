...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = {
    {FUNC(30), CM_Q, CM_W, CM_F, CM_P, CM_G, KC__MUTE, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_POWER},
    {KC_BSPC, CM_A, CM_R, CM_S, CM_T, CM_D, KC__VOLUP, KC_F7, KC_F8, KC_F9, KC_TRNS, KC_PSCREEN},
    {KC_LGUI, CM_Z, CM_X, CM_C, CM_V, CM_B, KC__VOLDOWN, KC_F4, KC_F5, KC_F6, KC_TRNS, KC_TRNS},
    {KC_LALT, KC_LCTL, KC_LSFT, KC_ESC, FUNC(10), KC_SPC, FUNC(20), KC_F1, KC_F2, KC_F3, KC_TRNS, M(0)}
  },
