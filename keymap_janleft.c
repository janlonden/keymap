...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = {
    {KC_ESC, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_LGUI, CM_Q, CM_W, CM_F, CM_P, CM_G, KC_TRNS},
  ...
  [10] = {
    ...
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, FUNC(10), KC_TAB, KC_ENT}
  },
