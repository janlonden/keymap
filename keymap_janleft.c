...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [10] = {
    {KC_TRNS, M(5), KC_BTN1, KC_BTN3, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    ...
    {KC_TRNS, M(3), M(4), KC_GRV, FUNC(10), KC_TAB, S(KC_TAB), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
  },
  ...
  [20] = {
    ...
    {KC_TRNS, KC_TRNS, LCTL(KC_MINS), LCTL(KC_EQL), KC_ENT, KC_TRNS, FUNC(20), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
  },
  ...
  [30] = {
    {FUNC(30), S(KC_SPC), KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    ...
    {KC_TRNS, KC_TRNS, LCTL(KC_PGUP), LCTL(KC_PGDOWN), KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
  }
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt) {
  switch(id) {
    ...
    break;
    case 3:
      return MACRODOWN(DOWN(KC_LGUI), DOWN(KC_LCTL), TYPE(KC_LEFT), UP(KC_LCTL), UP(KC_LGUI), END);
    break;
    case 4:
      return MACRODOWN(DOWN(KC_LGUI), DOWN(KC_LCTL), TYPE(KC_RIGHT), UP(KC_LCTL), UP(KC_LGUI), END);
    break;
    case 5:
      return MACRODOWN(DOWN(KC_LCTL), DOWN(KC_LALT), TYPE(CM_T), UP(KC_LALT), UP(KC_LCTL), END);
    break;
  }
  return MACRO_NONE;
};
