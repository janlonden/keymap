...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [10] = {
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, RALT(CM_Q), RALT(CM_W), KC_BTN2, KC_BTN3, KC_BTN1, KC_TRNS},
  ...
  [21] = {
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(CM_A), LCTL(CM_Q), LALT(CM_D), KC_TRNS, KC_TRNS},
