...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = {
    {FUNC(31), CM_Q, CM_W, CM_F, CM_P, CM_G, KC_TRNS, KC_TRNS, KC_F10, KC_F11, KC_F12, KC_POWER},
    {FUNC(30), CM_A, CM_R, CM_S, CM_T, CM_D, KC_TRNS, KC_TRNS, KC_F7, KC_F8, KC_F9, KC_PSCREEN},
    {KC_LGUI, CM_Z, CM_X, CM_C, CM_V, CM_B, KC_TRNS, KC_TRNS, KC_F4, KC_F5, KC_F6, KC_TRNS},
  ...
  [30] = {
    ...
    {KC_TRNS, LCTL(KC_MINS), LCTL(KC_EQL), KC_LEFT, M(1), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
